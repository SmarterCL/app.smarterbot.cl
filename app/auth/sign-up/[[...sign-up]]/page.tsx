                ...
                <div className="rounded-[26px] bg-white overflow-hidden">
                  ...
                  <div className="bg-gradient-to-r from-amber-50 to-orange-50 px-6 py-4 border-b border-amber-100">
                    <h3 className="text-xl font-bold text-gray-900 text-center">
                      <span className="lg:hidden">Crear Cuenta<br />Smarter</span>
                      <span className="hidden lg:inline">Crear Cuenta Smarter</span>
                    </h3>
                    <p className="text-xs text-gray-500 text-center mt-1">para comenzar con SmarterOS</p>
                  </div>
