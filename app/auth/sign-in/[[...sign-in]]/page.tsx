  ...
  return (
    <div className="fixed inset-0 overflow-hidden bg-black/90">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
        ...
        {/* Logo & Branding - Top on mobile, Left on large screens */}
        <div className="mb-8 flex flex-col items-center gap-4 text-center lg:absolute lg:left-12 lg:top-12 lg:mb-0 lg:items-start lg:text-left">
          ...
          <p className="hidden lg:block text-sm text-white/70 max-w-xs font-light">
            ...
            <div className="relative overflow-hidden rounded-[28px] bg-white/80 backdrop-blur-xl shadow-2xl ring-1 ring-white/50">
              ...
              <SignIn
                ...
                appearance={{
                  elements: {
                    rootBox: "w-full",
                    card: "bg-transparent shadow-none px-6 py-4 border-0 w-full",
                    main: "w-full",
                    form: "w-full gap-3",
                    header: "hidden",
                    headerTitle: "hidden",
