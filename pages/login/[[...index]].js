...
export default function SignInPage() {
    return (
        <div className="min-h-screen w-full flex flex-col lg:grid lg:grid-cols-2 bg-[#FFCE00] selection:bg-black selection:text-[#FFCE00]">
            <Head>
                <title>SmarterOS - Iniciar Sesión</title>
            </Head>
            ...
            <div className="relative hidden lg:flex flex-col items-center justify-center px-12 overflow-hidden bg-slate-950 min-h-screen w-full">
                ...
                <div className="absolute bottom-12 left-12 opacity-30">
                    <p className="text-xs font-black text-[#FFCE00] tracking-[0.5em] uppercase">Enterprise Grade Platform</p>
                </div>
            </div>

            {/* Right Column: Login Card */}
            <div className="flex flex-col items-center justify-center p-6 md:p-12 lg:p-16 relative min-h-screen w-full bg-[#FFCE00]">
                        ...
                        <div className="relative bg-white rounded-[40px] shadow-2xl border border-black/5 overflow-hidden">
                                ...
                                <SignIn
                                    ...
                                    appearance={{
                                        elements: {
                                            ...
                                            header: "hidden",
                                            socialButtonsBlockButton: "w-full h-14 bg-white hover:bg-slate-50 border-2 border-slate-100 transition-all duration-300 rounded-[22px] flex items-center justify-center shadow-sm active:scale-[0.98] hover:border-amber-400/50 hover:shadow-md",
                            ...
                            <div className="px-10 pb-10 pt-4 text-center">
                                <p className="text-sm font-bold text-slate-500 mb-6">
                                    ¿No tienes cuenta?{" "}
                                    <a href="/signup" className="text-slate-900 hover:text-[#FFCE00] font-black underline underline-offset-4 decoration-2 transition-colors">
                                        Regístrate gratis
                                    </a>
                                </p>
                                <a
